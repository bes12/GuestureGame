...
public class PuzzleMediumView extends RelativeLayout {
    ...
    public PuzzleMediumView( Activity activity, int width, int height,
                           int numberOfPieces ) {
        super( activity );
    ...
    public void fillGui( String [] scrambledText ) {
        int minFontSize = DynamicSizing.MIN_FONT_SIZE;
        for( int i = 0; i < tvs.length; i++ ) {
